...
const UUID = process.env.UUID || '8cfb5138-af07-4738-b673-a01aac9d3155'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz-agent.888529.xyz';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '9EEVqnexsaBqiErmdmJJtefIu8axnNuN';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo-01.888529.xyz';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTU4MjFlNzkzZGQ5MzkxMjNmZjExODgxMDBjOWQ2NWEiLCJ0IjoiZTAzYWJlNDktYTc1Yy00NjZhLWIyNWItZmE1MDc2YjNmY2QzIiwicyI6Ik5XSXlZVE0xT0dVdE5qbGxZUzAwWVRCaExUZzFZemt0WVdJd09URXhZMlZpTkRReSJ9';
const CFIP = process.env.CFIP || 'www.visa.com.tw';
const NAME = process.env.NAME || 'W-US-Choreo';
